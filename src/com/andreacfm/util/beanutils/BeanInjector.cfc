		...
		<cfif StructCount(variables.DICache[arguments.typeName]) gt 0>
			<cfloop collection="#variables.DICache[arguments.typeName]#" item="thisProperty">
				...
				<cfif variables.debugMode>
					<cftry>
					<cftrace text="The cached dependency #thisProperty# was successfully injected into #arguments.typeName#." inline="false">
					...
					<cftry>
						...
						<cfif getBeanFactory().containsBean(propertyName)>
							...
							<cfif suffixMatch>
								...
								<cfif variables.debugMode>
									<cftry>
									<cftrace text="The dependency #propertyName# was successfully injected into #arguments.originalTypeName# and cached." inline="false">
									<cfcatch type="any"></cfcatch>
									</cftry>
								</cfif>
